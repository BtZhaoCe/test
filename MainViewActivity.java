...
public class MainViewActivity extends Activity implements Runnable {
	...
	private void UPAppDetail(PackageInfo packageInfo) {	
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("更新?");
		StringBuffer message = new StringBuffer();
		message.append("程序名称:" + packageInfo.applicationInfo.loadLabel(getPackageManager()));
		message.append("\n 包名:" + packageInfo.packageName);//包名
		message.append("\n 当前版本号:" + packageInfo.versionCode);//版本号
		message.append("\n 当前版本名:" + packageInfo.versionName);//版本名		
		builder.setMessage(message.toString());
		builder.setPositiveButton("更新", new DialogInterface.OnClickListener() {
			
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Toast.makeText(MainViewActivity.this, "更新成功", Toast.LENGTH_SHORT).show();
			}
		});
		builder.setNegativeButton("取消", null);//仅仅是让Dialog消失
